...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_regWidget_t, stringdata0) + ofs), len 
...
const QMetaObject regWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_regWidget.offsetsAndSize,
    qt_meta_data_regWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_regWidget_t
